...
dpg.create_context()
dpg.create_viewport(title="Python Music Player",large_icon="icon.ico",small_icon="icon.ico")
pygame.mixer.init()
...
with dpg.theme(tag="slider_thin"):
	with dpg.theme_component():
		dpg.add_theme_color(dpg.mvThemeCol_FrameBgActive, (134, 149, 250,99))
...
with dpg.window(tag="main",label="window title"):
	...
	with dpg.group(horizontal=True):
		with dpg.child_window(width=200,tag="sidebar"):
			dpg.add_text("Play Music",color=(137, 142, 255))
			dpg.add_spacer(height=2)
